...
import { NotificationProvider, useNotification, NotificationHistoryButton, NotificationHistoryDrawer, NotifyFunctions, NotificationHistoryEntry } from './NotificationContext'

// Context type for test consumer callback
...
interface TestConsumerProps {
  onMount?: (context: TestContext) => void
}

// Test component that uses the notification context
function TestConsumer({ onMount }: TestConsumerProps): React.ReactElement {
...
describe('NotificationContext', () => {
  ...
  describe('notification options', () => {
    it('respects custom duration option', () => {
      let notifyFn: NotifyFunctions | undefined
