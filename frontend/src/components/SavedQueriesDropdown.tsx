...
/**
 * Props for the SavedQueriesDropdown component.
 */
export interface SavedQueriesDropdownProps {
  /** Connection ID to filter queries */
  connectionId: string
  /** Database name to filter queries */
  database: string
  /** Collection name to filter queries */
  collection: string
  /** Callback when a query is selected */
  onSelectQuery?: (query: string) => void
  /** Callback to open the queries manager */
  onManageQueries?: () => void
  /** Trigger to refresh the queries list */
...
export default function SavedQueriesDropdown({
  ...
  onManageQueries,
  refreshTrigger = 0,
}: SavedQueriesDropdownProps): React.ReactElement {
