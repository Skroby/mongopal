...
import ErrorBoundary, { getPreservedState, clearPreservedState, hasPreservedState, PreservedState } from './ErrorBoundary'
...
function ThrowError({ shouldThrow = true }: ThrowErrorProps): JSX.Element {
  if (shouldThrow) {
...
describe('ErrorBoundary', () => {
  ...
  describe('reload', () => {
    ...
    it('saves state before reload', () => {
      ...
      const preserved = getPreservedState() as PreservedState
